...
<a href={url} target="__blank">
  <button
    ...
    class="flex items-center px-32 space-x-16 w-auto h-72 text-on-background-variant font-bold rounded-md border-4 border-primary-main transition ease-in-out hover:border-secondary-main duration-500"
  >
    <div
